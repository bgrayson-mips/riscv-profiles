...
It is the intention that these optional extensions will be included
in the next major release.

This is a minor release of the RVA23 Profile series. As such, this release
does not contain any new mandatory extensions and is expected to be
...
in a command line argument, all instances of the period will
...
supervisor-mode execution environment in 64-bit application
processors.  `rva23p1s64` is designed to be added on to, and requires,
an implementation of `rva23s64` for Mandatory Base and Mandatory
